...
public class UndoRedoAdapter {
    //private static final String TAG = UndoRedoAdapter.class.getCanonicalName();
    ...
    public UndoRedoAdapter(TextView textView) {
        mTextView = textView;
    ...
    public void undo() {
        ...
        for (Object o : text.getSpans(0, text.length(), CharacterStyle.class)) {
            text.removeSpan(o);
        }
    ...
    private final class EditTextChangeListener implements TextWatcher {
        ...
        private void makeBatch(int start) {
            ...
            if ((lastActionType != at || ActionType.PASTE == at || System.currentTimeMillis() - lastActionTime > 300) || editItem == null) {
